...
_REPORT_ISOBARS_WIDTH_PX = round(
    _REPORT_ISOBARS_WIDTH_MM * _REPORT_ISOBARS_DPI / 25.4
)
_REPORT_ISOBARS_HEIGHT_PX = round(
    _REPORT_ISOBARS_HEIGHT_MM * _REPORT_ISOBARS_DPI / 25.4
)
