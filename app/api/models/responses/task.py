...
MmbResponse = BaseResponse[dto.TaskMmb]
CompensationResponse = BaseResponse[dto.TaskCompensation]
WellTestResponse = BaseResponse[dto.TaskWellTest]
OwcRespResponse = BaseResponse[dto.TaskOwcResp]
